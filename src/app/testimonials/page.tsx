...
import bannerImage from "../../assets/3d-rendering-modern-design-marble-tile-toilet-bathroom-wardrobe-with-walk-closet.jpg"
    ...
    <div>
      ...
      <section>
        ...
        <div className="absolute inset-0 flex mb-20 flex-col items-center justify-center z-20 text-white text-center px-4 md:px-8">
          ...
          >
            See how Armani Floorings has transformed spaces and earned trust across every project
          </p>
